;
(function(ns) {
    CPSSLib.RegNameSpace(ns).addDepartment = (function () {
        var self;
        ...
        var fn_button_click = function (sender) {
            ...
            switch (id) {
                case "rtBasicDep_TB_Add_Save":
                    fn_postData(undefined, "/basic/adddepartment", function (result) {
                        if (result.ErrorCode === 0)
                    ...
                    break;
                case "rtBasicDep_TB_Add_Save_Go":
                    fn_postData(undefined, "/basic/adddepartment", function (result) {
                        if (result.ErrorCode === 0)
                            _msgbox.success(result.ErrorMessage,
                                function () {
