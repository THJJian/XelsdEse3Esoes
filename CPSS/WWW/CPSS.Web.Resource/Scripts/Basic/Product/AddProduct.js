;
(function(ns) {
    CPSSLib.RegNameSpace(ns).addProduct = (function () {
        var self;
        ...
        var fn_button_click = function (sender) {
            ...
            switch (id) {
                case "rtBasicProduct_TB_Add_Save":
                    fn_postData(undefined, "/basic/addproduct", function (result) {
                        if (result.ErrorCode === 0)
                    ...
                    break;
                case "rtBasicProduct_TB_Add_Save_Go":
                    fn_postData(undefined, "/basic/addproduct", function (result) {
                        if (result.ErrorCode === 0)
                            _msgbox.success(result.ErrorMessage,
                                function () {
                    ...
                    break;
                case "rtBasicProduct_TB_Add_Cancel":
                    parent._window.close();
                    break;
            }
        }
