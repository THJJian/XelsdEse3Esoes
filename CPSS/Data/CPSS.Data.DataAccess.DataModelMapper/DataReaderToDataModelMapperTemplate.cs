...
namespace CPSS.Data.DataAccess
{
	...
	public static class DataReaderMapHelper
	{
        ...
        /// <param name="reader"></param>
        /// <param name="entity"></param>
		public static void Map(IDataReader reader, CPSS.Data.DataAcess.DataModels.Entities entity)
		{
			var mapper = new DataReaderToEntitiesMapper();
			mapper.Map(reader, entity);
		}
	...
	public static class DataAccessExecuteReaderExtentions
    {
		...
		/// 执行sql转换到单个实体
		/// </summary>
		public static CPSS.Data.DataAcess.DataModels.Entities ExecuteReadSqlToEntities(this DataAccessBase dataAccessBase, bool isProc = false)
        {			
            using(var reader = dataAccessBase.QueryGetDataReader(isProc))
			{
				if(reader.Read())
		...
		/// 执行sql转换到单个实体
		/// </summary>
		public static CPSS.Data.DataAcess.DataModels.Entities ExecuteReadSqlToEntities(this DataAccessBase dataAccessBase,IDbTransaction trans, bool isProc = false)
        {			
            var reader = dataAccessBase.QueryGetDataReader(trans,isProc);
			CPSS.Data.DataAcess.DataModels.Entities result = null;
			if(reader.Read())
			{
				result = new CPSS.Data.DataAcess.DataModels.Entities();
				DataReaderMapHelper.Map(reader, result);
			}
			reader.Close();
			dataAccessBase.AfterDataAccessHandler(dataAccessBase.DataParameter);
		...
		/// 执行sql转换到实体列表
		/// </summary>
		public static List<CPSS.Data.DataAcess.DataModels.Entities> ExecuteReadSqlToEntitiesList(this DataAccessBase dataAccessBase, bool isProc = false)
        {			
			var result = new  List<CPSS.Data.DataAcess.DataModels.Entities>();
            using(var reader = dataAccessBase.QueryGetDataReader(isProc))
			{
				while(reader.Read())
				{
					var entity = new CPSS.Data.DataAcess.DataModels.Entities();
					DataReaderMapHelper.Map(reader, entity);
					result.Add(entity);
				}
				reader.Close();
		...
		///// 执行sql转换翻页数据
		///// </summary>
		//public static PageData<CPSS.Data.DataAcess.DataModels.Entities> ExecuteReadSqlToEntitiesPageData(this DataAccessBase dataAccessBase,  string sqlString, int pageIndex, int pageSize, string primaryKey, string pageSort, bool isReturnTotalCount)
        //{			
			//var result = new  PageData<CPSS.Data.DataAcess.DataModels.Entities>();
            //using(var reader = DataAccessHelper.GetPageList(dataAccessBase.Connection, sqlString, pageIndex, pageSize, primaryKey, pageSort, isReturnTotalCount))
			//{
				//var listData = new List<CPSS.Data.DataAcess.DataModels.Entities>();
				//while(reader.Read())
				//{
					//var entity = new CPSS.Data.DataAcess.DataModels.Entities();
					//DataReaderMapHelper.Map(reader, entity);
